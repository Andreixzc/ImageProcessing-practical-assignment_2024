...
plot_class_distribution(class_counts_before, "Class Distribution Before Resampling")
...
plot_class_distribution(class_counts_after, "Class Distribution After Resampling")
